    ...
    <>
      <Container>
        <div className="banner-container">
          <Image
            ...
            src="/images/other/BlueGitHubLogo.png"
          />
        ...
        <div className="text-container">
          ...
          <p className="github-resources-section-p">
      ...
      <Container className="git-container">
        <Row className="git-links-row">
          <h3 className="resources-section-h3 install-git"> Installing Git:</h3>
        ...
        <Row className="git-links-row">
          <h3 className="resources-section-h3 install-github"> GitHub:</h3>
          <a className="git-links" href="https://github.com/">
            <i class="fab fa-github fa-2x"> GitHub </i>
          </a>
        </Row>

        <Container className="git-card-container">
          ...
          <Card className="git-card" border="dark">
            <Card.Body className="git-card-body">
              <Card.Title className="git-card-title">BRANCH & MERGE</Card.Title>
              <Card.Text className="git-card-text">
